...
import { measurements as mockMeasurements, teams as mockTeams, TYPE_LABELS, MeasurementType, Measurement, Team } from '../data/mockData';
import { api } from '../api/client';
import { useApi } from '../api/useApi';
import StatusBadge from '../components/StatusBadge';
import { ArrowLeft, Search, Filter, Edit, MapPin, ChevronDown, ChevronUp, Clock } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4">
        ...
        <div className="flex gap-2">
          <select
            ...
            className="px-3 py-2.5 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm appearance-none focus:ring-2 focus:ring-blue-500 outline-none"
          >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden divide-y divide-gray-100 dark:divide-gray-700/50">
        ...
        {filtered.map(m => {
          ...
          const isRecent = Date.now() - new Date(m.timestamp).getTime() < 3600000 * 4; // 4hrs
                ...
                <div className="px-4 pb-4 pt-1 bg-gray-50/50 dark:bg-gray-900/30">
                  <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                    ...
                    <div>
                      ...
                      <StatusBadge value={m.severity} type="severity" />
                    </div>
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="text-gray-700 dark:text-gray-300">{m.notes}</div>
                    </div>
                  </div>
                  {isRecent && (
